...
function after_submit_step1(data){
    ...
    if (obj.Code=='Success') {
        jQuery(".steps-container.step-1 .step-arrow").css('background-color', '#0b72b5');
        jQuery(".steps-container.step-2").css('background-color', '#0b72b5');
        jQuery(".steps-container.step-2 .step-no").css('color', '#0b72b5');
        jQuery(".steps-container.step-2 .step-arrow").css('background-position', '-123px -9px');
